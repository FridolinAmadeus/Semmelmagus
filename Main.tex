...
\input{Part1/01_Sphaerologische_Betrachtungen.tex}\clearpage
\input{Part1/02_Magostatik.tex}\clearpage
...
\bibitem{erzzwerge} \textsc{Leskolombrosch} Sohn des \textsc{Leskándin} (Hrsg.), Gesammelte Mathematik der Erzzwerge, Königliche Bibliothek von Xorlosch, 825 BF
