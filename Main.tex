...
\input{Part1/01_Astralfeldtheorie.tex}\clearpage
\part{Viae mathematicae artis magicae}
\input{Part2/01_Unwahrscheinlichkeitskalkuel.tex}\clearpage
...
\bibitem{informationstheorie} \textsc{Turgrim}, Sohn des Tietzax, \emph{Die Theorie der Information}, Königliche Bibliothek von Xorlosch, 763 BF
\bibitem{apokryphen} Apokryphen von \textsc{Rohal} dem Weisem, Universitätsbibliothek zu Punin, um 580 BF
\end{thebibliography}
\end{document}
